                        ...
                        <div class="card card-details">
                            ...
                            <div class="attendee">
                                <table class="table table-responsive-sm text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="https://ui-avatars.com/api/?name={{$detail->username}}" alt="avatar-checkout" 
                                            ...
                                            <td class="align-middle">
                                                <a href="{{route('checkout-remove',$detail->id)}}">
                                                    <img src="{{url('frontend/images/ic_remove.png')}}" alt="remove icon">
                                                </a>
                                            </td>
                                        </tr>
                                        @empty
                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline" method="POST" action="{{route('checkout-create',$item->id)}}">
                                    ...
                                    <input type="text" name="username" class="form-control mb-2 mr-sm-2" id="username" placeholder="Username" required style="width:130px">
                        ...
                        <div class="card card-details card-right">
                            ...
                            <div class="bank">
                                <div class="bank-item pb-3">
                                    <img src="{{url('frontend/images/ic_bank_1.png')}}" alt="bank image" class="bank-image">
                                ...
                                <div class="bank-item pb-3">
                                    <img src="{{url('frontend/images/ic_bank_2.png')}}" alt="bank image" class="bank-image">
                                    <div class="description">
                                        <h3>PT Nomads ID</h3>
                                        <p>
                                            1732 2567 1490 <br> Bank HSBC
                                        </p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
...
@push('addon-script')
    ...
    <script>
        $('.datepicker').datepicker({
            ...
            icons: {
                rightIcon: '<img src="{{url('frontend/images/ic_calendar.png')}}" width="20" style="margin-left:-3px;"/>'
            }
        })
    </script>
@endpush