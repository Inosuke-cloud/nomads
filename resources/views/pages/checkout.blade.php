                ...
                <div class="row">
                    <div class="col-lg-8 pl-lg-0">
                        <div class="card card-details">
                            <h1>Who is Going?</h1>
                            <p>Trip to Supertree Grove, Singapore</p>
                            <div class="attendee">
                                <table class="table table-responsive-sm text-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{url('frontend/images/avatar-1.png')}}" alt="avatar-checkout" height="60">
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{url('frontend/images/avatar-2.png')}}" alt="avatar-checkout" height="60">
                                            </td>
                                            <td class="align-middle">
                                                Xie Chen Lai
                                            </td>
